def send_email(message, recipient, sender="university.help@gmail.com"):
    ...
    elif sender == "university.help@gmail.com" and (".com" or ".ru" or ".net") in (recipient or sender) and "@" in (recipient or sender):
...
send_email('Пожалуйста, исправьте задание',
           'urban.student@mail.ru', sender='university.help@gmail.com')
